...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (!isset($_POST['admin_password']) || empty($_POST['admin_password'])) {
        ...
        if ($admin && password_verify($admin_password, $admin['admin_password'])) {
            $delete_query = "DELETE FROM orders WHERE archived = 1";
            if (mysqli_query($conn, $delete_query)) {
                $success = "All archived orders have been deleted successfully.";
            } else {
                $error = "Error deleting archived orders: " . mysqli_error($conn);
            }
        } else {
...
<div class="content-box">
    <div class="update">
        <h2 class="text-center">Verify Admin Password to Delete All Archived Orders</h2>
        <form method="POST" class="row g-3">
            ...
            <div class="col-12 d-flex justify-content-between">
                <button type="submit" class="btn btn-danger">Delete All Archived Orders</button>
