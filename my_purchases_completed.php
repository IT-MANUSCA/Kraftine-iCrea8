...
function renderTable($orders) {
  global $conn;
  if (count($orders) === 0) return "<p style='text-align:center; font-size: 1.2rem; color: #555;'>No completed orders.</p>";
    ...
    $output .= "</table>
      <div class='order-footer'>
        ...
        <div class='action-buttons'>
          <button class='btn blue' onclick=\"openModal('rate')\">Rate</button>
        </div>
      </div>
    </div>";
  }
...
<div style="max-width: 950px; margin: auto;">
  <?php echo renderTable($completed); ?>
</div>
...
function openModal(action) {
  ...
  if (action === 'Rate') {
    title.innerText = "Rate";
    msg.innerText = "Rating will be available soon.";
  }
